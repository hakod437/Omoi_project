    ...
    return (
        <div className="relative flex p-1.5 bg-muted/50 backdrop-blur-sm rounded-full mb-8 border border-border/50 shadow-sm">
            ...
            <button
                ...
                disabled={isLoading}
                className={`relative flex-1 py-2 text-sm font-ui font-medium rounded-full transition-colors z-10 outline-none disabled:opacity-50 ${activeTab === 'inscription' ? 'text-slate-900' : 'text-slate-500 hover:text-slate-700'
                    }`}
            >
                Inscription
